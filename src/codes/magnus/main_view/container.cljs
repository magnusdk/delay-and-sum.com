(ns codes.magnus.main-view.container
  (:require [cljs.math :as math]
            ...
            [codes.magnus.main-view.layers.grid :as grid]
            [codes.magnus.main-view.layers.main-simulation :as main-simulation]
            [codes.magnus.main-view.layers.simplified-wave-geometry :as simplified-wave-geometry]
            [codes.magnus.main-view.layers.simulation-ui :as simulation-ui]
...
(defn container []
  [:div#simulationCanvasesContainer.stackedContainer
   {:style {:cursor (if (-> (re/rget *state :simulation-container-draggable :fsm :current-state)
                            #{:hovering :dragging})
                      "pointer"
                      "default")}
